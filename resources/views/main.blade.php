...
<body>
                    ...
                    <div class="col-lg-6 col-md-9">
                        ...
                        <div class="hero-content">
                            ...
                            <div class="section-title">
                                <h1 class="wow fadeInUp" data-wow-delay="0.2s">Your Trusted <span>Mental Health Companion</span></h1>
                                <h3 class="wow fadeInUp">Making mental health services accessible to everyone with secure online consultations, licensed professionals, and seamless medicine delivery.</h3>
                            </div>
                            <!-- Section Title End -->
                            ...
                            <div class="hero-btn wow fadeInUp" data-wow-delay="0.4s">
                                <a href="contact.html" class="btn-default">get in touch</a>
                                <a href="book-appointment.html" class="btn-default btn-highlighted">Download Mobile App</a>
                            </div>
                            <!-- Hero Button End -->
                        </div>
                        <!-- Hero Content End -->
                    ...
                    <div class="col-lg-12">
                        <div class="export-coaching-box wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="export-coaching-step">
                                <div class="icon-box">
                                    <img src="{{asset('images/icon-export-coaching-1.svg')}}" alt="">
                                </div>
                            ...
                            <div class="export-coaching-step">
                                <div class="icon-box">
                                    <img src="{{asset('images/icon-export-coaching-2.svg')}}" alt="">
                                </div>
                                <div class="export-coaching-step-content">
                            ...
                            <div class="export-coaching-step">
                                <div class="icon-box">
                                    <img src="{{asset('images/icon-export-coaching-3.svg')}}" alt="">
                                </div>
                                <div class="export-coaching-step-content">
                                    <p>Medicine Ordering</p>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
                            <!-- Export Coaching Step End -->
                            ...
                            <div class="export-coaching-step">
                                <div class="icon-box">
                                    <img src="{{asset('images/icon-export-coaching-4.svg')}}" alt="">
                                </div>
                                <div class="export-coaching-step-content">
                                    <p>Flexible and secure payments</p>
                                </div>
                            </div>
                            <!-- Export Coaching Step End -->
                            ...
                            <div class="export-coaching-step">
                                <div class="icon-box">
                                    <img src="{{asset('images/icon-export-coaching-5.svg')}}" alt="">
                                </div>
                                <div class="export-coaching-step-content">
                                    <p>Certified specialist with Ongoing Support</p>
                                </div>
                            </div>
                            <!-- Export Coaching Step End -->
                        </div>
                    ...
                    <div class="about-us-images">
                        ...
                        <div class="about-us-img-1">
                            <figure class="image-anime">
                                <img src="{{asset('images/about-us-img-1.jpg')}}" alt="">
                            </figure>
                        </div>
                        <!-- About Us Img End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.2s">Making Mental Health <span>Care Accessible.</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">We believe everyone deserves access to quality mental health care. Our platform bridges the gap between patients and mental health professionals, making support accessible, secure, and convenient.</p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        {{-- <div class="about-us-body">
                            ...
                            <div class="about-comapny-client wow fadeInUp" data-wow-delay="0.8s">
                                ...
                                <div class="company-client-images">
                                    ...
                                    <div class="client-image">
                                        <figure class="image-anime">
                                            <img src="{{asset('images/satisfy-client-img-2.jpg')}}" alt="">
                                        </figure>
                                    </div>
                                    <div class="client-image">
                                        <figure class="image-anime">
                                            <img src="{{asset('images/satisfy-client-img-3.jpg')}}" alt="">
                                        </figure>
                                    </div>
                                    <div class="client-image">
                                        <figure class="image-anime">
                                            <img src="{{asset('images/satisfy-client-img-4.jpg')}}" alt="">
                                        </figure>
                                    </div>
                                    <div class="client-image">
                                        <figure class="image-anime">
                                            <img src="{{asset('images/satisfy-client-img-5.jpg')}}" alt="">
                                        </figure>
                                    </div>
                                </div>
                            ...
                            <div class="about-company-result wow fadeInUp" data-wow-delay="0.8s">
                                <div class="icon-box">
                                    <img src="{{asset('images/icon-company-result.svg')}}" alt="">
                                </div>
        ...
        <div class="container">
            <div class="row section-row align-items-center">
                <div class="col-lg-7">
                    <!-- Section Title Start -->
                    <div class="section-title">
                        <h3 class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">our approach</h3>
                        <h2 class="wow fadeInUp" data-wow-delay="0.25s" style="visibility: visible; animation-delay: 0.25s; animation-name: fadeInUp;">Empowering growth through <span>personalized guidance</span></h2>
                    </div>
                    <!-- Section Title End -->
                </div>
                ...
                <div class="col-lg-5">
                    <!-- Section Btn Start -->
                    <div class="section-btn wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="our-approach-content">
                        {{-- <p class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">At the heart of our coaching philosophy is a commitment to empowering individuals and businesses to reach their fullest potential. We provide personalized, one-on-one guidance tailored to your unique goals and challenges. </p> --}}
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="mission-vision-item wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                                        ...
                                        <div class="mission-vision-content">
                                            <h3>our mission</h3>
                                            <p>Making mental health services accessible to everyone by connecting patients with licensed professionals through secure, convenient digital platforms.</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="mission-vision-item wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                                        ...
                                        <div class="mission-vision-content">
                                            <h3>our vision</h3>
                                            <p>A future where quality mental health care is available to all, breaking down barriers of distance, stigma, and accessibility.</p>
                                        </div>
                                    </div>
                                    <!-- Mission Vision Item End -->
                                </div>
                                ...
                                {{-- <div class="col-lg-12 col-12">
                                    ...
                                    <div class="mission-vision-item our-value-item wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                                        <div class="icon-box">
                                        ...
                                        <div class="mission-vision-content">
                                            <h3>our value</h3>
                                            <p>Our values are rooted in integrity, empathy, and empowerment. We are committed to creating a supportive.</p>
                                        </div>
                                    </div>
                                    <!-- Our Value Item End -->
                                </div> --}}
                        ...
                        <div class="our-approach-content-footer wow fadeInUp" data-wow-delay="0.8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                            <a href="contact.html" class="btn-default">Let's work together to turn your goals into reality. <u>Contact us Today</u> </a>
                        </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="service-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.25s">Comprehensive Mental Health <span>Solutions</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.5s">Designed for both patients seeking care and professionals providing treatment.</p>
                        </div>
                        <!-- Section Title End -->

                        <!-- Service Btn Start -->
                        {{-- <div class="service-btn wow fadeInUp" data-wow-delay="0.75s">
                            <a href="service.html" class="btn-default">view all services</a>
                        </div> --}}
                        <!-- Service Btn End -->
                    </div>
                    <!-- Service Content End -->
                    ...
                    <div class="service-item-list">
                        ...
                        <div class="service-item wow fadeInUp">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>Schedule consultations with licensed psychiatrists and therapists at your convenience.</p>
                            </div>
                        </div>
                        <!-- Service Item Start -->
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>Connect with mental health professionals through encrypted video calls.</p>
                            </div>
                        </div>
                        <!-- Service Item Start -->
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>Order prescribed medicines directly from the app with home delivery.</p>
                            </div>
                        </div>
                        <!-- Service Item Start -->
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>Register and get verified on our platform with proper credential verification.</p>
                            </div>
                        </div>
                        <!-- Service Item Start -->
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div class="service-item-content">
                                <h3>Secure Therapy Sessions</h3>
                                <p>Conduct confidential therapy sessions through our encrypted platform.</p>
                            </div>
                        </div>
                        <!-- Service Item Start -->
                        ...
                        <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>Manage appointments, patient interactions, and treatment plans efficiently.</p>
                            </div>
                        </div>
                        <!-- Service Item Start -->
                    </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="pricing-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.25s">Coaching <span>packages that fit</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.5s">Our coaching packages are designed to meet diverse needs and budgets, providing flexibility for every individual and organization. Whether you're seeking personal.</p>
                        </div>
                        <!-- Section Title End -->

                        <!-- Pricing Btn Start -->
                        <div class="pricing-btn wow fadeInUp" data-wow-delay="0.75s">
                            <a href="book-appointment.html" class="btn-default">get all touch</a>
                        </div>
                        <!-- Pricing Btn End -->
                    </div>
                    <!-- Pricing Content End -->
                    ...
                    <div class="pricing-box-list">
                        ...
                        <div class="pricing-box highlighted-box wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="pricing-box-content">
                                <!-- Pricing Title Start -->
                                <div class="pricing-title">
                                    <p>standerd package</p>
                                    <h2><sup>$</sup>299<sub>/month</sub></h2>
                                </div>
                                <!-- Pricing Title End -->

                                <!-- Pricing Button Start -->
                                <div class="pricing-btn">
                                    <a href="#" class="btn-default btn-highlighted">purchase now</a>
                                </div>
                                <!-- Pricing Button End -->
                            </div>
                            <!-- Pricing Box Content End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="our-expertise-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.25s">Certified and experienced <span>coaching professionals</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.5s">Choosing us means partnering with experienced coaches who are dedicated to unlocking your potential. We offer personalized strategies, proven methods.</p>
                        </div>
                        <!-- Section Title End -->
                    ...
                    <div class="expertise-list">
                        ...
                        <div class="expertise-item wow fadeInUp">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-1.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>communication coaching</p>
                            </div>
                        </div>
                        <!-- Expertise Item End -->
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-2.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-3.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>Strategy</p>
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="0.8s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-4.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>Productivity & Efficiency Coaching</p>
                            </div>
                        </div>
                        <!-- Expertise Item End -->
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="1s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-5.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>Health Coach</p>
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="1.2s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-6.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>Leadership</p>
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="1.4s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-7.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>Marketing Coaching</p>
                            </div>
                        </div>
                        <!-- Expertise Item End -->
                        ...
                        <div class="expertise-item wow fadeInUp" data-wow-delay="1.6s">
                            <div class="expertise-image">
                                <figure class="image-anime">
                                    <img src="{{asset('images/expertise-image-8.jpg')}}" alt="">
                                </figure>
                            </div>
                            <div class="expertise-content">
                                <p>Career Transition Coaching</p>
                            </div>
                        </div>
                        <!-- Expertise Item End -->
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-8">
                    ...
                    <div class="section-title wow fadeInUp">
                        <h2>Watch our coaching  videos for <span>practical tools</span></h2>
                    </div>
                    <!-- Section Title End -->
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-video-list wow fadeInUp" data-wow-delay="0.25s">
                        <ul>
                            <li>Personal and Professional Success</li>
                            <li>Your Potential with Expert Coaching</li>
                            <li>Tailored Strategies for Growth</li>
                            <li>Empowering Your Journey Success</li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="how-work-item wow fadeInUp">
                        <div class="icon-box">
                            <img src="{{asset('images/icon-how-work-1.svg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="how-work-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="icon-box">
                            <img src="{{asset('images/icon-how-work-2.svg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="how-work-item wow fadeInUp" data-wow-delay="0.4s">
                        <div class="icon-box">
                            <img src="{{asset('images/icon-how-work-3.svg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="how-work-item wow fadeInUp" data-wow-delay="0.6s">
                        <div class="icon-box">
                            <img src="{{asset('images/icon-how-work-4.svg')}}" alt="">
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="scrolling-ticker-box">
                            ...
                            <div class="scrolling-content">
                                <span><img src="{{asset('images/asterisk-icon.svg')}}" alt="">Stress Management</span>
                                <span><img src="{{asset('images/asterisk-icon.svg')}}" alt="">Business Coaching</span>
                                <span><img src="{{asset('images/asterisk-icon.svg')}}" alt="">Career Support</span>
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <div class="company-growth-image">
                        <figure class="image-anime reveal">
                            <img src="{{asset('images/company-growth-img.jpg')}}" alt="">
                        </figure>
                    </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="company-growth-content">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h3 class="wow fadeInUp">wo we are</h3>
                            <h2 class="wow fadeInUp" data-wow-delay="0.25s">Unlock your potential <span>with our expertise</span></h2>
                            <p class="wow fadeInUp" data-wow-delay="0.5s">Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the industry's standard dummy text ever since</p>
                        </div>
                        <!-- Section Title End -->
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="our-testimonial-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="0.25s">Real success stories from our <span>coaching clients</span></h2>
                        </div>
                        <!-- Section Title End -->
                    </div>                    
                </div>
                                        ...
                                        <div class="testimonial-slider-content">
                                            <div class="testimonial-header">            
                                                <div class="testimonial-rating-company">
                                                    <img src="{{asset('images/icon-testimonial-rating-4.svg')}}" alt="">
                                                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="testimonial-rating-box">
                        ...
                        <div class="testimonial-rating-item">
                            <div class="icon-box">
                                <img src="{{asset('images/icon-testimonial-rating-1.svg')}}" alt="">
                            </div>
                        ...
                        <div class="testimonial-rating-item">
                            <div class="icon-box">
                                <img src="{{asset('images/icon-testimonial-rating-2.svg')}}" alt="">
                            </div>
                            <div class="testimonial-rating-content">
                        ...
                        <div class="testimonial-rating-item">
                            <div class="icon-box">
                                <img src="{{asset('images/icon-testimonial-rating-3.svg')}}" alt="">
                            </div>
                            <div class="testimonial-rating-content">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="our-blog-content">
                        <!-- Section Title Start -->
                        <div class="section-title">
                            <h3 class="wow fadeInUp">news/post</h3>
                            <h2 class="wow fadeInUp" data-wow-delay="0.25s">Latest updates and coaching <span>industry insights</span></h2>
                        </div>
                        <!-- Section Title End -->

                        <!-- Our Blog Button Start -->
                        <div class="our-blog-btn wow fadeInUp" data-wow-delay="0.5s">
                            <a href="contact.html" class="btn-default">contact us</a>
                        </div>
                        <!-- Our Blog Button End -->
                    </div>
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-item wow fadeInUp">
                            ...
                            <div class="blog-item-body">
                                ...
                                <div class="blog-item-content">
                                    <h2><a href="blog-single.html">Mental Wellness and Resilience The Power of Coaching</a></h2>
                        ...
                        <div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="blog-item-body">
                                <!-- Blog Item Content Start -->
                                <div class="blog-item-content">
                                    <h2><a href="blog-single.html">How to Maintain Work-Life Balance in a Busy World</a></h2>
                                    <p>Maintaining work-life balance in today's fast-paced world can be challenging.</p>
                                </div>
                                <!-- Blog Item Content End -->
                        ...
                        <div class="blog-item wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="blog-item-body">
                                <!-- Blog Item Content Start -->
                                <div class="blog-item-content">
                                    <h2><a href="blog-single.html">The Power of Mindset Transforming Your Life & Business</a></h2>
                                    <p>A positive mindset fuels growth, success, and resilience in life and business.</p>
                                </div>
                                <!-- Blog Item Content End -->
	...
	<script src="{{asset('/js/theme-panel.js')}}"></script>
</body>
</html>